...
public class ObjectFactory {
    ...
    private final static QName _Convert_QNAME = new QName("http://sid.org/", "Convert");
    private final static QName _ConvertResponse_QNAME = new QName("http://sid.org/", "ConvertResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://sid.org/", name = "Convert")
     ...
     */
    @XmlElementDecl(namespace = "http://sid.org/", name = "ConvertResponse")
